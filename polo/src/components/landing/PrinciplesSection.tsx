  ...
  const principles = [
    {
      ...
      description: "Cross-chain bridge routing powered by LI.FI. Real quotes, fee-aware decisions, and optimal path selection across Base, Arbitrum, Optimism, and Polygon.",
      align: "left",
    },
    {
      number: "02",
      ...
      description: "Deposits into Aave V3 lending pools — the highest-yielding USDC positions across all supported L2 chains.",
      align: "right",
    },
    {
      number: "03",
      ...
      description: "Compound V3 market data feeds real-time APY signals to the decision engine for cross-protocol comparison.",
      align: "left",
    },
    {
      number: "04",
      ...
      description: "DeFiLlama scans 10+ protocols every 60 seconds to surface the highest USDC yields across 4 L2 chains.",
      align: "right",
    },
  ]
