...
const signals = [
  {
    date: "STEP 01",
    title: "Scan",
    note: "Monitors 10 DeFi protocols via DeFiLlama every 60s for the best USDC yields across 4 L2 chains.",
  },
  {
    date: "STEP 02",
    title: "Decide",
    note: "An AI engine evaluates bridge costs, APY differentials, and net profit before committing to a move.",
  },
  {
    date: "STEP 03",
    title: "Execute",
    note: "Withdraws from Aave, bridges cross-chain via LI.FI, and deposits into the highest-yielding pool — one autonomous cycle.",
  },
]
