    ...
    >
      ...
      <div ref={gridRef} className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-8 md:gap-12">
        ...
        <div className="col-span-1">
          ...
          <ul className="space-y-2">
            ...
            <li className="font-mono text-xs text-foreground/80">DeFiLlama</li>
          </ul>
        </div>
        ...
        <div className="col-span-1">
          ...
          <ul className="space-y-2">
            <li className="font-mono text-xs text-foreground/80">Alchemy RPCs</li>
            <li className="font-mono text-xs text-foreground/80">Web3.py</li>
          </ul>
        </div>
        ...
        <div className="col-span-1">
          ...
          <ul className="space-y-2">
            ...
            <li className="font-mono text-xs text-foreground/80">Polygon</li>
          </ul>
        </div>
      ...
      >
        <p className="font-mono text-[10px] text-muted-foreground uppercase tracking-widest">
          © 2026 BRAHMA. Built for the LI.FI Vibeathon.
        </p>
        <p className="font-mono text-[10px] text-muted-foreground">Autonomous Cross-Chain Yield Agent · Powered by LI.FI</p>
      </div>
    </section>
  )
}
